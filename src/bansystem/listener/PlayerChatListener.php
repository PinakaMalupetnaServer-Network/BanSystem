        ...
        if ($muteList->isBanned($player->getName())) {
            ...
            if ($entry->getExpires() == null) {
                ...
                if ($reason != null || $reason != "") {
                    $muteMessage = TextFormat::RED . "You are currently muted for " . TextFormat::WHITE . $reason . TextFormat::RED . ".";
                } else {
                ...
                if ($muteReason != null || $muteReason != "") {
                    $muteMessage = TextFormat::RED . "You are currently muted for " . TextFormat::WHITE . $reason . TextFormat::RED . " until " . TextFormat::WHITE . $expiry . TextFormat::RED . ".";
                } else {
                    $muteMessage = TextFormat::RED . "You are currently muted until " . TextFormat::WHITE . $expiry . TextFormat::RED . ".";
                }
            }
    ...
    public function onPlayerChat2(PlayerChatEvent $event) {
        ...
        if ($muteList->isBanned($player->getAddress())) {
            ...
            if ($entry->getExpires() == null) {
                $reason = $entry->getReason();
                if ($reason != null || $reason != "") {
                    $muteMessage = TextFormat::RED . "You are currently IP muted for " . TextFormat::WHITE . $reason . TextFormat::RED . ".";
                } else {
                ...
                $muteReason = $entry->getReason();
                if ($muteReason != null || $muteReason != "") {
                    $muteMessage = TextFormat::RED . "You are currently IP muted for " . TextFormat::WHITE . $muteReason . TextFormat::RED . " until " . TextFormat::WHITE . $expiry . TextFormat::RED . ".";
                } else {
                    $muteMessage = TextFormat::RED . "You are currently IP muted until " . TextFormat::WHITE . $expiry . TextFormat::RED . ".";
                }
            }
            $event->setCancelled(true);
            $player->sendMessage($muteMessage);
